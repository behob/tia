...
| PRD-07 | Subscribe with consent     | Newsletter requires explicit consent, Turnstile and `NEWSLETTER_ENABLED=true`; it creates a Resend contact. No success is shown on provider failure. Campaigns require an unsubscribe process.                                                                      | Production capture is active and Contacts access is verified. No subscriber or unsubscribe flow has been tested. |
